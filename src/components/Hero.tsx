  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 py-20 bg-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-conic from-orange-500/30 via-red-500/20 to-transparent rounded-full blur-3xl animate-spin-slow"></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-conic from-red-500/20 via-orange-500/30 to-transparent rounded-full blur-3xl animate-spin-reverse"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full">
          <div className="w-full h-full bg-gradient-radial from-orange-500/5 via-red-500/5 to-transparent animate-pulse-slow"></div>
        </div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 lg:gap-32 items-center z-10">
        ...
        <div className="space-y-12 animate-fade-in">
          <div className="space-y-10">
            <h1 className="text-7xl lg:text-8xl font-light text-white leading-[0.9] tracking-tight">
              I'm <span className="font-medium bg-gradient-to-r from-orange-400 via-red-400 to-orange-500 bg-clip-text text-transparent animate-shimmer">Lora</span>, who loves
        ...
        {/* Right Content - Enhanced Mockups with Parallax */}
        <div className="relative animate-fade-in">
          <div className="relative z-10">
            {/* Desktop Mockup with Parallax */}
            <div 
              className="group glass-card rounded-3xl p-2 mb-12 transform rotate-2 hover:rotate-0 transition-all duration-700 hover:shadow-2xl hover:shadow-orange-500/20"
              style={{
                transform: `translate(${mousePosition.x * 0.02}px, ${mousePosition.y * 0.02}px) rotate(2deg)`,
            ...
            {/* Mobile Mockup with Enhanced Parallax */}
            <div 
              className="group absolute -bottom-20 -left-20 glass-card rounded-3xl p-2 w-60 transform -rotate-6 hover:rotate-0 transition-all duration-700 hover:shadow-2xl hover:shadow-red-500/20"
              style={{
                transform: `translate(${mousePosition.x * -0.03}px, ${mousePosition.y * -0.03}px) rotate(-6deg)`,
                transition: 'transform 0.1s ease-out'
              }}
            >
              <div className="bg-gray-900/80 rounded-2xl overflow-hidden backdrop-blur-sm border border-gray-700/50">
          ...
          <div className="absolute top-20 right-20 w-32 h-32 bg-gradient-to-br from-orange-400/30 to-red-400/30 rounded-full blur-3xl animate-pulse-slow"></div>
          <div className="absolute bottom-40 right-12 w-24 h-24 bg-gradient-to-br from-red-400/20 to-orange-400/20 rounded-full blur-2xl animate-pulse-slow" style={{ animationDelay: '1.5s' }}></div>
        </div>
      </div>
    </section>
  );
